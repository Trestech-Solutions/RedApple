...
function SocialLink({
  ...
  return (
    <a
      ...
      aria-label={label}
      className={`flex h-9 w-9 items-center justify-center rounded-full transition-colors ${bg} ${color}`}
    >
      {icon}
    </a>
  )
      ...
      <div className="mx-auto max-w-[1400px] px-4 sm:px-5 md:px-8">
        ...
        <div className="flex flex-col items-center gap-8 border-b border-neutral-200 py-10 sm:flex-row sm:items-center sm:justify-between sm:gap-6">
          ...
          <div className="text-center sm:text-right">
            ...
            <div className="mt-3 flex justify-center gap-2 sm:justify-end">
              <SocialLink href={social?.facebook_link  ?? ''} label="Facebook"  icon={<FacebookIcon />}  bg="bg-blue-50  hover:bg-blue-100"   color="text-blue-600"  />
              <SocialLink href={social?.instagram_link ?? ''} label="Instagram" icon={<InstagramIcon />} bg="bg-pink-50  hover:bg-pink-100"   color="text-pink-500"  />
              <SocialLink href={social?.twitter_link   ?? ''} label="Twitter"   icon={<TwitterIcon />}   bg="bg-gray-100 hover:bg-gray-200"   color="text-gray-800"  />
              <SocialLink href={social?.youtube_link   ?? ''} label="YouTube"   icon={<YoutubeIcon />}   bg="bg-red-50   hover:bg-red-100"    color="text-red-600"   />
              <SocialLink href={social?.tiktok_link    ?? ''} label="TikTok"    icon={<TiktokIcon />}    bg="bg-gray-100 hover:bg-gray-200"   color="text-gray-900"  />
              <SocialLink href={social?.linkedin_link  ?? ''} label="LinkedIn"  icon={<LinkedinIcon />}  bg="bg-blue-50  hover:bg-blue-100"   color="text-blue-700"  />
              <SocialLink href={social?.snapchat_link  ?? ''} label="Snapchat"  icon={<SnapchatIcon />}  bg="bg-yellow-50 hover:bg-yellow-100" color="text-yellow-500" />
              <SocialLink href={social?.pinterest_link ?? ''} label="Pinterest" icon={<PinterestIcon />} bg="bg-red-50   hover:bg-red-100"    color="text-red-500"   />
              <SocialLink href={social?.whatsapp_link  ?? ''} label="WhatsApp"  icon={<WhatsappIcon />}  bg="bg-green-50 hover:bg-green-100"  color="text-green-600" />
            </div>
